...
const FastAnnouncementModal = ({ isOpen, onClose, announcement }) => {
        ...
        >
          ...
          <div className="p-6">
            <div className="rounded-lg border border-green-200 bg-gradient-to-r from-green-50 to-emerald-50 p-6">
              ...
              {/* Content - Using dangerouslySetInnerHTML for speed with proper styling */}
              <div 
                className="global-announcement-content prose prose-lg max-w-none text-gray-700"
...
export default FastAnnouncementModal;